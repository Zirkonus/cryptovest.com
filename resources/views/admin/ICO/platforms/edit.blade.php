        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::model($platform, ['method' => 'POST', 'url' => 'admin/ico/platform/edit/' . $platform->id , 'files' => true]) !!}
                         <div class="form-group">
                             {!! Form::label("name", "Name of Platform : ", ["class"=>"control-label col-sm-2", "style"=>"padding-top:4px"]) !!}
                             <div class="col-sm-10 my-label">
                                 {!! Form::text("name", $platform->name , ["class" =>"form-control", "required"=>"required"]) !!}
                             </div>
                         </div>
                         <div class="col-sm-12">
                             <div class="col-sm-6">
                                 <div class="form-group" style="padding-top: 15px">
                                     ...
                                     <img style = "width: 75px; height: 75px;" src="{{asset($platform->icon)}}" alt="money icon">
                                 </div>
                             </div>
                             <div class="col-sm-6">
                         ...
                         <div class="col-sm-12">
                             <div class="checkbox">
                                 <label><input name="is_active" id="is_active" type="checkbox" {{($platform->is_active) ? "checked" : "" }}> Is active</label>
                             </div>
                         </div>
                        <div class="form-group">
