            ...
            <div class="panel-heading clearfix">
                <div class="form-inline">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('executives.supports.create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> Add New</a>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <table class="table table-bordered " id="table">
                    ...
                    @foreach ($supports as $support)
                        <tr>
                            <td><a href="{{ route('executives.supports.edit', $support->id) }}">{{ $support->name }}</a></td>
                            <td style="text-align: left;">
                                <a href="{{ route('executives.supports.edit', $support->id) }}">
                                    <i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="edit executive"></i>
                                </a>
                                <a class="delete_item" data-action="{{$support->id}}" data-lname="{{$support->name}}">
    ...
    <script>
        $(document).ready(function () {
            $('.delete_item').click(function () {
                var action = '/admin/executives/supports/delete/' + $(this).data('action');
