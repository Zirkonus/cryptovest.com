            ...
            <div class="col-lg-12">
                <div class="panel panel-primary ">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['url' => 'admin/language-keys/create']) !!}
                        @foreach($languages as $lang)
                            <div class="lang_{{$lang->id}}" @if($lang->is_main == 0) style="display:none" @else style="display:block" @endif>
                                <div class="form-group">
                                    {!! Form::label('key_'.$lang->id, 'Key: ', ['class' =>"control-label col-sm-2", "style"=>"padding-top:4px"]) !!}
                                    <div class="col-sm-10 my-label">
                                            {!! Form::text('key_'.$lang->id, null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    {!! Form::label('value_'.$lang->id, 'Key: ', ['class' =>"control-label col-sm-2", "style"=>"padding-top:4px"]) !!}
                                    <div class="col-sm-10 my-label">
                                        {!! Form::text('value_'.$lang->id, null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-4">
                                <a class="btn btn-danger" href="{{ route('language-keys.index') }}">Cancel</a>
